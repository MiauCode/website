  ...
  if (skill.name != "")
    return (
      ...
      >
        ...
        {isHovered && (
          <div
            className={`absolute z-50 w-44 max-w-sm p-4 bg-bodyColor border border-gray-200 rounded-lg shadow dark:bg-white-800 dark:border-gray-700 transition-shadow duration-200 ease-linear transform hover:shadow-2xl hover:-translate-y-1 hover:shadow-designColor/100 ${
              isSmallViewport
